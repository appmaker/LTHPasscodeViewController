Pod::Spec.new do |s|
  ...
  s.source_files  = 'LTHPasscodeViewController', 'LTHPasscodeViewController/*.{h,m}','NumPadTextField/*.{h,m}'
  s.resources = ["NumPadTextField/*.xib", "NumPadTextField/Resource/*.png"]
  s.requires_arc = true
